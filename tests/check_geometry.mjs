...
const propertiesCoverStage=editor.slice(editor.indexOf('function propertiesCoverStage(){'),editor.indexOf('function clampView(){'));
...
for (const [w,h,dpr] of [[393,627,2.75],[360,572,3],[412,682,2.625],[393,437,2.75]]) {
  ...
  vm.runInNewContext(propertiesCoverStage+clampView+applyView+fit+'fit();',{window:{devicePixelRatio:dpr},document:{body},mode:'edit',stage:{clientWidth:w,clientHeight:h},phone,$:()=>badge,view,layout,Math});
